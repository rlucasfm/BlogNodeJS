...
router.post("/registro", (req,res) => {
    ...
    if(!req.body.senha || typeof req.body.senha == undefined || req.body.senha == null) erros.push({texto: "Senha inválido"})
    if(req.body.senha != req.body.senha2) erros.push({texto: "As senhas estão diferentes"})
                ...
                bcrypt.genSalt(10, (err, salt)=> {
                    bcrypt.hash(novoUsuario.senha, salt, (erro, hash) => {
                        ...
                        novoUsuario.save().then(() => {
                            ...
                            req.flash("error_msg", "Houve um erro durante o registro do usuário, tente novamente")
                            res.redirect("/usuarios/registro")
                        })
                    })
                })
